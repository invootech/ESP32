/*
  LED End-to-Center Chaser Program
  This program turns on and off LEDs connected to digital pins 
  14, 27, 26, 25, 33, and 32 of an ESP32 microcontroller. The LEDs 
  glow inward starting from the outermost LEDs (LED 1 on pin 14 and LED 6 on pin 32) 
  and move symmetrically toward the center (LED 3 on pin 26 and LED 4 on pin 25). 
  Each pair of LEDs lights up for 150 milliseconds before turning off, 
  creating a chaser effect from the ends toward the center LEDs. (Even LED Count)
  Pin assignments:
    Pin 14: LED 1 (end)
    Pin 27: LED 2
    Pin 26: LED 3 (center)
